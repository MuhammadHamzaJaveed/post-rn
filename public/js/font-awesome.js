...
!function (t) {
    ...
    var E, P = function () {
        ...
        k = "undefined" == typeof setImmediate ? setTimeout : setImmediate, F = [];
    ...
    H.prototype = {
        constructor: H, _state: "pending", _then: null, _data: void 0, _handled: !1, then: function (t, e) {
    ...
    function X(t, e) {
        ...
        }(t) && ("URLSearchParams" in window ? (i = new URL(t)).searchParams.set("token", o) : i = i + "?token=" + encodeURIComponent(o)), i = i.toString(), new q((function (t, e) {
    ...
    function Y(t, n) {
        ...
        }, o = n.document || o, i = j.bind(j, o, [].concat(b, m, p.map((function (t) {
            return "fa-".concat(t)
        }))));
        t.autoA11y.enabled && r(i);
        var a = t.subsetPath && t.baseUrl + "/" + t.subsetPath, c = [{id: "fa-main", addOn: void 0, url: a}];
        ...
        var f = c.map((function (r) {
            return new q((function (o, i) {
                var a = r.url || O(t, {addOn: r.addOn, minify: t.minify.enabled}), c = {id: r.id},
    ...
    function G(t, n) {
        ...
        return t.v4shim.enabled && r.push(new q((function (r, o) {
            X(O(t, {addOn: "-v4-shims", minify: t.minify.enabled}), n).then((function (t) {
                r($(t, e(e({}, n), {}, {id: "fa-v4-shims"})))
            })).catch(o)
        }))), r.push(new q((function (r, o) {
            X(t.subsetPath && t.baseUrl + "/" + t.subsetPath || O(t, {minify: t.minify.enabled}), n).then((function (t) {
    ...
    try {
        if (window.FontAwesomeKitConfig) {
            var V = window.FontAwesomeKitConfig, W = {
                ...
                document: document
            }, Z = document.currentScript, tt = Z ? Z.parentElement : document.head;
            (function () {
