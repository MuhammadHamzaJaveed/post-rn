...
class UpdateOverseasAggregate extends Command
{
    protected $userServices;
    protected $signature = 'updateOverseasAggregate';
    /**
    ...
    public function handle(): void
    {
        ...
        $users->chunk(50, function ($users) {
            foreach ($users as $user) {
                ...
                DB::table('users')->where('id',$user->id)->update(['aggregate_overseas'=>$generalAggregate]);
