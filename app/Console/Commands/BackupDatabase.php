...
class BackupDatabase extends Command
{
    ...
    protected $description = 'Create an SQL dump';
    ...
    public function handle()
    {
        try{
            ...
            $command = "mysqldump --no-tablespaces --user={$username} --password={$password} --host={$host} {$databaseName} > {$sqlDumpFile}";
